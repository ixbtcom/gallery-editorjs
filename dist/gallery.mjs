...
const I = class I {
  constructor({ api: t, config: e, onSelectFile: s, onSelectUrl: i, onColumnsChange: r, onRemoveImage: n, readOnly: l }) {
    this.currentColumns = 1, this.previousColumns = 1, this.isRendering = !1, this.columnsLocked = !1, this.api = t, this.config = e, this.onSelectFile = s, this.onSelectUrl = i, this.onColumnsChange = r, this.onRemoveImage = n, this.readOnly = l, this.nodes = {
            ...
            function f(E, _) {
              try {
                if (_ && (typeof _ == "object" || typeof _ == "function")) {
                  var k = _.then;
                  if (typeof k == "function") return void k.call(_, function(F) {
                    f(E, F);
                  }, c);
                }
                C[E] = _, --m == 0 && d(C);
